...
def lossFun(loader, optimizer, model, mm_crit, att_crit, opt, iter):
    ...
    # forward
    tic = time.time()
    scores, _, sub_attn, loc_attn, rel_attn, _, _, att_scores, image_logits, text_logits = model(Feats['pool5'],
                                                                                                 Feats['fc7'],
                                                                                                 Feats['lfeats'],
                                                                                                 Feats['dif_lfeats'],
                                                                                                 Feats['cxt_fc7'],
...
def main(args):
    infos = json.load(open('/home/lizhongguo/src/MAttNet/output/refcocog_umd/lock_loc_11m1_sub_11p_rel_00.json'))
    opt = infos['opt']
    ...
    # set up model
    model_path = '/home/lizhongguo/src/MAttNet/output/refcocog_umd/lock_loc_11m1_sub_11p_rel_00.pth'
    ...
    while True:
        ...
        if iter % opt['save_checkpoint_every'] == 0 or iter == opt['max_iters']:
            ...
            if best_val_score is None or current_score > best_val_score:
                ...
                checkpoint_path = osp.join(checkpoint_dir, 'lock_loc_11m1_sub_11p_rel_00_5w.pth')
                checkpoint = {}
            ...
            with open(osp.join(checkpoint_dir, 'lock_loc_11m1_sub_11p_rel_00_5w.json'), 'wb') as io:
